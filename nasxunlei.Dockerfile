...
# 从spk中提取所需要的文件
RUN mkdir -p ${SPK_TARGET} \
  && (curl -SsL https://down.sandai.net/nas/nasxunlei-DSM7-x86_64.spk | tar -Ox package.tgz | tar --wildcards -xJC ${SPK_TARGET} 'bin/bin/*' 'ui/index.cgi')
